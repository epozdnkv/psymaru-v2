      ...
      card: [
        ...
        },
        {
          ...
          description: `
                ...
                <p>Она не пытается изменить людей и обстоятельства в угоду своему ЭГО, а потому ей не свойственно так сильно страдать, когда что-то идет не по ее, как волку. </p>
        ...
        },
        {
          ...
          name: "Морская свинка",
          description: `
                <p>Согласно верованиям шаманов Южной Америки, морская свинка забирает болезни и отводит неудачи от хозяина.</p>
                <p>Это воплощение мягкости и кротости — социальные животные, лишённые агрессии, символ спокойствия и безмятежности.</p>
                <p>А в вашей душе живёт покой? Что могло бы вернуть вам чувство умиротворения?</p>`,
        },
        {
          id: 3,
          ...
          description: `
                ...
                <p>Возможно, что-то внутри вас или в вашем поведении может нанести вам вред. Что ядовитого вы делаете для себя? Что в ваших действиях может отравить вас?</p>
                <p>Возможно, у вас получится сделать змею вашим проводником на пути личной трансформации и внутреннего исцеления.</p>`,
        },
        {
          id: 4,
        ...
        },
        {
          ...
          description: `
                ...
                <p>Копайте глубже в свое внутреннее существо. Это поможет вам понять свои истинные мотивы. Таким образом, вы можете знать, как лучше всего взаимодействовать с окружающим миром.</p>`,
        },
        {
          id: 6,
          ...
          description: `
                ...
                <p>Сделайте вдох и выдох, возвысьтесь на мгновение над жизненными ненастьями подобно этой птице, преодолевающей дождевые облака.</p>`,
        },
        {
          id: 7,
          ...
          description: `
                ...
                <p>Доверяйте собственным органам чувств и интуиции, слушайте свой внутренний голос.</p>`,
        },
        {
          id: 8,
          ...
          name: "Орёл",
          description: `
                <p>Когда силы на исходе и душа устала, прислушайся к голосу своей сути — в нём найдёшь источник возрождения.</p>
                <p>Орёл напоминает: истинная мудрость рождается, когда принимаешь жизнь во всей её полноте — и светлую радость, и тёмную печаль.</p>
                <p>Каждое событие — и горькое, и сладкое — ведёт к пробуждению твоего высшего Я.</p>
                <p>В минуты испытаний помни: лишь расправив духовные крылья, можно воспарить над суетой, увидеть новые горизонты и обрести крылья для полёта к настоящему себе.</p>`,
        },
        {
          id: 9,
          ...
          description: `
                ...
                <p>Дух крокодила дает нам сигнал о том, что нам нужно проявлять силу и агрессию в нашей повседневной деятельности. </p>
                <p>Кроме того, он служит нам напоминанием о том, что в работе нужно иметь мужество, терпение и честь.</p>`,
        },
        {
          id: 10,
          ...
          description: `
                ...
                <p>Подобно оленю не принимайте поспешных решений; олень замирает, оценивая новую обстановку всеми своими чувствами и затем ступает вперед грациозно и и уверенно – чтобы не ждало его дальше.</p>`,
        },
        {
          id: 11,
          ...
          description: `
                ...
                <p>Достаточно ли вы разборчивы? Замечаете ли вы, что некоторые вещи пахнут не так, как должны пахнуть?</p>`,
        },
        {
          id: 12,
        ...
        },
        {
          ...
          description: `
                ...
                <p>У кошек есть понимание свободы, так как кошка не желает быть ни пойманной, ни заключенной. Вы никогда не заставите кошку делать то, что она не хочет и что ей не выгодно.</p>
                <p>Кот предлагает вам быть гибким, но не прогибаться.</p>`,
        },
      ],
    };
  },
  created() {
    ...
    if (dayCardCookie != undefined) {
      ...
      if (savedCardId >= 1 && savedCardId <= 19) {
        ...
        console.log("Карта дня из куки:", this.numRnd);
      } else {
        this.numRnd = 0;
        console.log("Некорректная карта в куки, показываем плейсхолдер");
      }
    } else {
      // Если куки нет, показываем плейсхолдер (numRnd = 0)
      this.numRnd = 0;
      console.log("Карта дня еще не выбрана");
    }
  },
  methods: {
